...
.then(async (data) => {
  ...
  document.getElementById("rangT2").innerHTML = data.data.periodes[1].ensembleMatieres.rang + "/" + n_eleve ;
  document.getElementById("rangGlobal").style.display = "block";
  document.getElementById("rangGlobal").innerHTML = data.data.periodes[3].ensembleMatieres.rang + "/" + n_eleve;
  discipline = []
  global = []
